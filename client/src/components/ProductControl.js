...
class ProductControl extends Component {
    ...
    componentDidMount(){
        axios.get('http://34.41.4.229:4000/api/products') // update api from port 5000 to 4000 for backend compatibility
            .then(res =>{
                console.log(res)
                this.setState({
    ...
    handleAddingNewProduct = (newProduct) =>{
        ...
        // }       
        // console.log(...formData)
        axios.post('http://34.41.4.229:4000/api/products', newProduct) // update api from port 5000 to 4000 for backend compatibility
    ...
    handleDeletingProduct = (id) =>{
        axios.delete('http://34.41.4.229:4000/api/products/'+id) // update api from port 5000 to 4000 for backend compatibility
            .then(res => console.log(res.data))
            .catch((error) =>{
                console.log(error)
            })
    ...
    handleEditingProduct = (editedProduct) =>{
        ...
        axios.put('http://34.41.4.229:4000/api/products/' + this.state.selectedProduct._id, editedProduct) // update api from port 5000 to 4000 for backend compatibility
            .then(res =>console.log(res.data))
